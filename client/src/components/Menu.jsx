...
const Sidebar = styled.menu`
	...
	animation: 0.3s both ease-in-out
		${(props) => (props.close === true ? "close" : "open")};
...
const Menu = ({ sidebar, setSidebar }) => {
	...
	const getChannels = async () => {
		try {
			const res = await axiosInstance.get("/users/subs", {
			...
			<Sidebar tabIndex={0} close={close}>
				...
				<Container>
					<Wrapper>
						...
						<Link to={currentUser === null ? "nosubscriptions" : "subscriptions"} >
							<Item>
